...
public class Menu {
    ...
    public interface Handler {
        void execute() throws CircuitoJaExisteException;
    }
     ...
     * @param opcoes Uma lista de Strings com as opções do menu.
     */
    public Menu(List<String> opcoes) { this("RacingManager v.1", opcoes); }
     ...
     */
    public void runOnce() throws CircuitoJaExisteException {
        int op;
        show();
        op = readOption();
        // testar pré-condição
     ...
     */
    public void run() throws CircuitoJaExisteException {
        int op;
        do {
            show();
            op = readOption();
